 ...
 * <p>Login Handler.</p>
 */
public class RequestDownloadPicHandler implements RequestHandler {
...
//                "</html>"
        ...
        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + MainActivity.screenshotPath + subDirName);
        if (file.exists() && file.isDirectory()) {
            ...
            for (int i = 0; i < filelist.length; i++) {
                ...
                if (!readfile.isDirectory()) {
                    ...
                    sStart += "<a href=\"/download?dir=" + "pics123" + "&&filename=" + readfile.getName() + "\">" + readfile.getName() + "</a> \n";
